...
const DEFAULTS: SiteSettings = {
  ...
  why_advance_note_urdu: 'COD آرڈرز میں بعض اوقات پارسل روانہ ہونے کے بعد وصول نہیں کیے جاتے، جس سے ڈیلیوری کا نقصان ہوتا ہے۔ اسی لیے صرف ڈیلیوری چارجز کی معمولی رقم پہلے لی جاتی ہے تاکہ آرڈر کی تصدیق ہو سکے۔ پروڈکٹ کی باقی مکمل قیمت آپ ڈیلیوری کے وقت ادا کریں گے۔ اگر آرڈر ہماری طرف سے منسوخ ہو تو پیشگی رقم مکمل واپس کر دی جائے گی۔',
  cod_policy_english: 'To confirm your order, only the delivery charges are required in advance. The full product price is paid at delivery, and the advance delivery amount is not deducted from the product price.',
  cod_language: 'ur',
