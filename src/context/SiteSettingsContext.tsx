...
const DEFAULTS: SiteSettings = {
  ...
  cod_policy_urdu: 'آپ کا آرڈر کنفرم کرنے کے لیے 350 روپے ایڈوانس درکار ہے۔ یہ رقم آپ کے کل بل میں سے منہا کر دی جائے گی۔ باقی رقم آپ ڈیلیوری کے وقت ادا کریں گے۔',
